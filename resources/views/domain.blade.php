        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="section-title position-relative text-center mx-auto mb-4 pb-4 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3">Create Your Website</h1>
                ...
                <div class="position-relative w-100 my-5 wow fadeInUp " data-wow-delay="0.3s">
                    {{-- <input class="form-control bg-transparent w-100 py-3 ps-4 pe-5" type="text" placeholder="Enter your domain name"> --}}
                    <a href="{{route ('posts.create')}}" class="btn btn-primary py-2 px-5 position-absolute top-50 end-50 mt-2 me-2">Start</a> <br>
